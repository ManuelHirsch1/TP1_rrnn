...
\begin{enumerate}
	...
	\begin{table}[htbp]
		...
		\begin{tabular}{cc}
			...
			\bottomrule
		\end{tabular}
		\caption{Valores teóricos de probabilidad de error y capacidad límite (Tabla 2.1, sección 2.2, \cite{hertz1991}, pág. 19).}
...
\subsection{Metodología experimental para patrones descorrelacionados}
\label{subsec:metodologia_ej2}

Para obtener experimentalmente los valores de capacidad requeridos en el cuadro~\ref{tab:teorica_hertz} mencionada en la consigna, se diseñó un algoritmo que evalúa la probabilidad de error empírica de la red tras un único paso de actualización. El procedimiento computacional implementado consistió en los siguientes pasos:
...
\begin{enumerate}
	...
	\item \textbf{Actualización sincrónica:} Se presentó cada uno de los patrones originales $\xi^\mu$ como estado inicial de la red. A continuación, se aplicó exactamente una iteración con actualización sincrónica, recalculando el estado de las $N$ neuronas de manera simultánea.
...
\subsection{Capacidad de la red en función de la correlación}
