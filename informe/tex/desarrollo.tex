...
Para la tercer y última imagen con la que la red fue entrenada, se introdujeron distintas cantidades de ruido para ver como recuperaba las imagenes. Estos resultados se pueden ver en la figura \ref{fig:1_b_panda}. La transición se da exactamente igual que en los casos anteriores, solamente con un intermedio. De la misma manera que en las anteriores, existe un umbral donde el ruido es tanto que la red interpreta afinidad con otro patrón. La imagen del panda es mayoritariamente blanca, pero con $50\%$ de ruido se torna bastante oscura, razón por la que la red la confunde con la imagen \textbf{v.bmp}.
...
\begin{figure}[htbp]
	...
	\begin{subfigure}[b]{0.48\textwidth}
		...
		\caption{Rendimiento ante suma impar de patrones.}
